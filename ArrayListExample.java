...
public class ArrayListExample {
    ...
    public static void main(String[] args) {
        ...
        name.clear(); // Clearing the ArrayList
        System.out.println(name);
        // System.out.println("Size of the ArrayList: " + name.size());// Displaying the size of the ArrayList
        // System.out.println("Is the ArrayList empty? " + name.isEmpty());// Checking if the ArrayList is empty
